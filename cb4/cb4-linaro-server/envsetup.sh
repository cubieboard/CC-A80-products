...
#export CB_ROOTFS_IMAGE=${CB_ROOTFS_DIR}/linaro-trusty-server-20141024-684.tar.gz
export CB_ROOTFS_IMAGE=${CB_ROOTFS_DIR}/linaro-server-trusty-20141024-684.tar.gz
export CB_ROOTFS_SIZE=580
